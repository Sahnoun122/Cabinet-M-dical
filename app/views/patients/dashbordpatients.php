...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-80 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    ...
    <div class="flex flex-col">
        <img src="" alt="Lawyer Photo" class="object-cover">
        <div class="px-3 py-4">
            <h2 class="text-3xl font-semibold text-center text-white mb-6">Rendez vous</h2>
...
<div class="flex-1 ml-0 sm:ml-80 p-8">
    <h2 class="text-4xl font-semibold text-black mb-10">les medcins avec leur Specialité <?php 
